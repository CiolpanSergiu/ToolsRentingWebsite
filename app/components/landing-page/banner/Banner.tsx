...
const Banner = () => {
  return (
    <div className={`relative mb-8 md:mb-0 w-full`}>
      <LandingPageOverlay />
      <MainOverlayTitle />
      <span className="text-ghostWhite text-2xl md:text-3xl top-[40%] centered-absolute-text">
        Gama larga de produse
      </span>
      <span className="text-ghostWhite text-3xl md:text-4xl top-[50%] centered-absolute-text">
