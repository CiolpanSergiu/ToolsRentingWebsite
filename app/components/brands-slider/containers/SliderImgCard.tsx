...
const SliderImgCard = () => {
  return (
    <div className="group mx-auto p-2 relative max-h-[190px] h-full rounded hover:scale-110 hover:z-40 hover:border-primary hover:border-4 hover:p-0 transition duration-150 ease-linear cursor-pointer">
